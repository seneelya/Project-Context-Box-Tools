...
def parse_args():
    ...
    while i < len(tokens):
        ...
        if token == '--file' and i + 1 < len(tokens):
            ...
            print("                      contents of just ONE block — the --level-th ancestor of line N")
            print("                      (0/default = innermost). --level here picks WHICH block, not a")
            print("                      depth cap. Zoom into one class/function inside a monster file.")
