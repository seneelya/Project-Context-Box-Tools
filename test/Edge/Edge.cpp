...
/// Print the build + version banner, then exit 0.
/// (Doc-comment preamble — must glue to this function.)
static int version(int /*argc*/, char ** /*argv*/) {
...
/* Block-comment preamble spanning
   several lines — entry point that routes
   argv[1] to the matching subcommand. */
