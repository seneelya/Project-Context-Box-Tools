...
- get_codeblock.py — gets the self-contained block around line N (code + Markdown), with a nesting ladder, framed `--query`, and `--outline` for a file's structural table of contents.
